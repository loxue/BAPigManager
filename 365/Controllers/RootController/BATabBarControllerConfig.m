...
- (NSArray *)tabBarItemsAttributesForController {
    ...
    NSDictionary *dict2 = @{
                            ...
                            CYLTabBarItemImage : @"tab_product_nor",
                            CYLTabBarItemSelectedImage : @"tab_product_sel"
                            };
    NSDictionary *dict3 = @{
                            CYLTabBarItemTitle : @"我的",
                            CYLTabBarItemImage : @"tab_personal_nor",
                            CYLTabBarItemSelectedImage : @"tab_personal_sel"
                            };
...
- (void)customizeTabBarAppearance:(CYLTabBarController *)tabBarController {
    ...
    [[UITabBarItem appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIResource getd2a36bColor], NSForegroundColorAttributeName, nil] forState:UIControlStateSelected];
}
