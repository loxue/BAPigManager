...
+ (void)initialize {
    ...
    [bar setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIResource get3e3e3eColor],NSForegroundColorAttributeName,MXFont17,NSFontAttributeName,nil]];//导航条标题颜色大小
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    if (self.childViewControllers.count > 0) { // 如果push进来的不是第一个控制器
        ...
        [button setImage:[UIImage imageNamed:@"tab_back"] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"tab_back"] forState:UIControlStateHighlighted];
