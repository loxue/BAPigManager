...
/// RGB颜色(16进制)
#define BAPickerRGBColor(r,g,b,a) [UIColor colorWithRed:r / 255.0 green:g / 255.0 blue:b / 255.0 alpha:a];

#import <UIKit/UIKit.h>
@interface BAPickerViewManager : NSObject
